...
var m=p,s=e('<div id="'+p.attr("id")+'"></div>');if(p.attr("name")){gFormName=p.attr("name");}
p.replaceWith(s);p=s;i=i.replace('class="dd-selected-value"','class="dd-selected-value" name="'+gFormName+'"');p.addClass("dd-container").append(i).append(a);var n=p.find(".dd-select"),u=p.find(".dd-options");u.css({width:l.width});n.css({width:l.width,background:l.background});p.css({width:l.width});if(l.height!=null){u.css({height:l.height,overflow:"auto"})}
